...
class Settings(BaseSettings):
    ...
    # Priorizar DATABASE_URL completa (Render proporciona esto)
    ...
    def DATABASE_URL(self) -> str:
        ...
        Prioriza DATABASE_URL si está disponible (Render proporciona esto),
        de lo contrario construye la URL desde variables individuales.
        """
